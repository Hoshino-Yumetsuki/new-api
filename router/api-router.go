...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		capRoute.POST("/:siteKey/challenge", controller.CapChallenge)
		capRoute.POST("/:siteKey/redeem", controller.CapRedeem)
		capRoute.POST("/:siteKey/siteverify", controller.CapSiteverify)
		capRoute.POST("/siteverify", controller.CapSiteverify)
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.PUT("/groups", controller.UpdateGroupSettings)
